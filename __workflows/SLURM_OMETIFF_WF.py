...
# This case it is for OME-TIFF but still converts to Zarr first 
...
def runScript():
    ...
    with SlurmClient.from_config() as slurmClient:
        ...
        params.description = f'''Script to run a workflow on OME-TIFF on the Slurm cluster.
        ...
        OMERO admin.
        '''
        params.name = 'Slurm OME-TIFF Workflow'
